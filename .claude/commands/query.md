...
Follow the **Query workflow** defined in `CLAUDE.md` (Workflows → Query). The summary:
...
6. On confirmation: create the synthesis page (template in `.claude/rules/templates/synthesis.md`), update `wiki/index.md`, append a `query` log entry
