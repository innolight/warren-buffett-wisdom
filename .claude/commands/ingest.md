...
Follow the **Ingest workflow** defined in `CLAUDE.md` (section 9). The summary:

1. Read the source in full
2. Identify metadata (author, year, doctype)
3. **Filter against the scope axes** (CLAUDE.md section 1, "Scope and focus") — keep only canonical entities, shaping people, and timeless concepts. Be willing to skip aggressively.
...
Use page templates from `CLAUDE.md` section 4. Use slug conventions from section 5.
