...
- **"How it's discussed in sources" is a thin thread, not a ledger.** Keep only the sources that *materially advanced* the idea (typically **6–12**), each in **one line saying what it added** — never the year's figures. Sources that merely restate get dropped or compressed ("restated annually 2008–2024"). This section is the chronicle magnet — cap it hard.
...
- [display](../sources/<slug>.md) — what *this* source added to the idea (6–12 max; drop pure restatements)
