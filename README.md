...
- [Margin of Safety](wiki/concepts/margin-of-safety.md) — the gap between what a business is worth and what you pay; the cornerstone of the whole approach.
- [Mr. Market](wiki/concepts/mr-market.md) — treat the market as a manic-depressive business partner, not a source of truth.
- [Circle of Competence](wiki/concepts/circle-of-competence.md) — invest only inside what you genuinely understand; know where the edge is.
- [Moat](wiki/concepts/moat.md) — the structural competitive advantage that protects a business's returns over time.
- [Intrinsic Value vs. Book Value](wiki/concepts/intrinsic-value-vs-book-value.md) — value is future cash output, not accounting input.
...
- [Capital Allocation](wiki/concepts/capital-allocation.md) — the CEO's central skill; how to judge management.
- [Share Repurchases](wiki/concepts/share-repurchases.md) — when buybacks create or destroy value.
- [Float](wiki/concepts/float.md) — how insurance premiums become an investing engine.
...
- [Investment Categories](wiki/concepts/investment-categories.md) — currency vs. sterile vs. productive assets.
- [American Tailwind](wiki/concepts/american-tailwind.md) — the long-run case for owning American business.
- [Equity Return Expectations](wiki/concepts/equity-return-expectations.md) — the GDP-tethered ceiling on long-run returns.
- [Bonds and Inflation](wiki/concepts/bonds-and-inflation.md) — why fixing a price while costs move destroys value.
- [Passive Investing](wiki/concepts/passive-investing.md) — the index-fund default for non-professionals.

**"What makes a business *good*?"**

- [Moat](wiki/concepts/moat.md) — the competitive advantage that resists erosion.
- [Economic Goodwill](wiki/concepts/economic-goodwill.md) — high returns on tangible capital.
- [Franchise vs. Business](wiki/concepts/franchise-vs-business.md) — what tolerates mismanagement and what doesn't.
- [Commodity Business Economics](wiki/concepts/commodity-business-economics.md) — why undifferentiated products earn poorly.
- [Turnarounds Seldom Turn](wiki/concepts/turnarounds-seldom-turn.md) — cheap bad businesses tend to stay bad.

**"What's it worth, and what do I pay?"**

- [Valuation Framework](wiki/concepts/valuation-framework.md) — the universal three-question DCF.
...
- [Mr. Market](wiki/concepts/mr-market.md) — ignore the mood, use the price.
...
Start at [the full index](wiki/index.md) for the complete catalog of concepts, entities, people, and sources.
