...
The 2008 financial crisis is the definitive empirical test of what actually drives consumer loan performance. The result overturned the industry assumption that FICO scores are the primary predictor: Clayton's borrowers — with a median FICO score of 644, a population classified as subprime — produced delinquency rates that dramatically outperformed pools of conventional mortgage borrowers with meaningfully higher credit scores.

The explanation is structural, not demographic. FICO tracks credit history. It does not measure whether the specific loan being made is within the borrower's means, whether the down payment is real, or whether the monthly payment is serviceable at the borrower's actual income. A borrower with a 750 FICO score can be a catastrophic credit risk if she takes a no-money-down loan with a teaser rate she cannot afford when it resets. A borrower with a 620 FICO score can be an excellent credit risk if she makes a 15% cash down payment and keeps monthly payments below a third of verifiable income.

The principle generalizes beyond mortgages. Any consumer credit instrument — auto loans, personal loans, buy-now-pay-later — lives or dies on the same three conditions. The product changes; the structural test does not.

## The FICO paradox

FICO score measures a borrower's historical relationship with debt. It does not measure:

- Whether the loan being extended is within her means
...
## The monthly-payment insight

The most important structural insight from the 2008 crisis is about the mechanism of foreclosure. Popular commentary treated foreclosures as an equity event: homeowners walked away because their house was worth less than their mortgage. This framing is wrong in most cases.

Most foreclosures are cash-flow events. Borrowers stop making payments because they cannot make the monthly payment they agreed to make — not because their house has declined in value. The distinction matters enormously for underwriting:

- **If foreclosure is an equity event**, then loan-to-value ratios and appraisals are the primary underwriting variables.
- **If foreclosure is a cash-flow event**, then payment-to-income ratio and down payment authenticity are the primary underwriting variables.

The evidence supports the cash-flow framing. A homeowner who made a meaningful down payment from real savings has genuine skin in the game. She is not going to walk away from her primary residence — a place her family lives — simply because paper value has declined 20%. She will keep making payments as long as she can make them. She walks when she cannot service the debt, period.

A borrower who made no down payment, or who borrowed the down payment, has no real equity to lose. At the first setback — job loss, rate reset, medical expense — she faces a pure economic calculation: keep making payments on an underwater asset, or stop. The structural incentive points toward stopping. The lender created that incentive on day one by accepting a borrowed down payment.
...
The principle generalizes: any consumer credit product framed as "expanding access" can be executed in a way that actually creates a transient access followed by a default, leaving the borrower worse off. Discipline in initial underwriting is the prerequisite for durable access, not a barrier to it.
...
| Insurance underwriting | Consumer lending |
|---|---|
| Price each risk for expected losses | Structure each loan for serviceability |
| Refuse business at inadequate pricing | Refuse loans that fail the three conditions |
