...
The recognition that the **structural economics of an industry** dominate the long-run results management can produce. Some businesses (insurance done well, branded consumer franchises) carry tailwinds — competent management compounds; mistakes are absorbed. Others (commodity textiles) carry headwinds — even very good management can produce only modest results.
