...
Academic finance, since the 1960s, has defined investment "risk" as the relative volatility of a stock or portfolio compared to a large universe of stocks — operationalized as "beta," the historical co-movement of a stock with the market. Build CAPM, dynamic hedging, and option-pricing models on that foundation, and the entire apparatus depends on volatility-as-risk.

## Buffett's rejection (1993)

The 1993 letter contains Buffett's most fully developed rejection of beta-as-risk. The argument has two parts.
...
### Part 2: beta ignores everything that actually matters
...
Two companies in the toy industry — one selling pet rocks, one selling Monopoly — may have identical betas. Their business risk is wildly different. Beta has no mechanism to distinguish them; an investor with rudimentary consumer-products judgment can.

## Buffett's substitute definition

In the same 1993 essay, Buffett defines risk by reference to what an investor actually cares about:
...
This is a definition of risk **in terms of permanent loss of purchasing power**, not in terms of price fluctuation. A stock that drops 40% and recovers caused no loss to an investor who did not need to sell at the bottom; a "low-beta" stock whose underlying business deteriorates causes permanent loss whether the price moved smoothly or not.

## The five-factor framework

To assess the actual risk in any prospective investment, the 1993 letter lists five factors — Buffett's qualitative substitute for beta:
...
Buffett's defense of the framework against the obvious critique:
...
The Coca-Cola and Gillette test: dominant share, durable brands, expanding international moats. Beta similar to many run-of-the-mill companies; actual business risk far below.
