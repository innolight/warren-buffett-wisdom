...
The 1990 letter, quoting Graham: "Forty-two years after reading that, I still think those are the right three words."

## Why it matters

Two reasons make margin of safety load-bearing rather than ornamental:

1. **Intrinsic value is an estimate.** Even with perfect analysis, future cash flows are unknowable. The discount rate is contestable. Two equally informed observers may produce intrinsic-value estimates ten percent apart. Buying at a discount to the estimate accounts for the fact that the estimate itself has error bars.

2. **Adverse surprises do happen.** Even wonderful businesses occasionally encounter genuine problems: a regulatory shift, a major product failure, a fraud, a recession that lasts longer than expected. A purchase price embedding a margin of safety preserves capital through these episodes; a purchase price equal to estimated intrinsic value does not.
