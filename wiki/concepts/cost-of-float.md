...
When underwriting is profitable (combined ratio < 100%), cost of float is negative — Berkshire is paid to hold investable funds. The benchmark: is cost of float below the long-term government bond yield? If so, the insurance operation outperforms the alternative of issuing debt to fund investments.

## Why it matters

The cost-of-float metric converts an insurance operation's underwriting results into a financing-cost equivalent. It allows direct comparison between insurance float and debt: both are liabilities, but float with negative cost is unambiguously superior to any bond. A multi-year average below zero is the mark of an underwriting-disciplined insurer.
