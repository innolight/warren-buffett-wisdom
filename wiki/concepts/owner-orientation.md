...
A public company should be run on the premise that its shareholders are partners in a business — not transient holders of a traded security. The mental and operating model is *managing-partner-for-owner-partners*, with corporate-form considerations subordinate to that relationship. The owner's manual published in the 1983 Berkshire letter is the canonical articulation.

## The 13 principles (1983 owner's manual)

Drawn from [berkshire-1983-letter](../sources/berkshire-1983-letter.md). Compressed:

1. **Corporate form, partnership attitude.** "We do not view the company itself as the ultimate owner of our business assets but, instead, view the company as a conduit through which our shareholders own the assets."
2. **Directors eat their own cooking.** ≥50% of family net worth in Berkshire for at least four of five directors.
3. **Long-term goal: maximize per-share intrinsic business value, not size.** "We measure by per-share progress."
4. **First preference: directly own diversified businesses that generate cash and earn above-average returns; second preference: own parts of such businesses via marketable equities.** Capital-allocation choice driven by price/availability and insurance-capital needs, not preference.
5. **GAAP-consolidated earnings reveal little.** Report by individual business and let owners judge.
6. **Accounting consequences do not drive operating or capital-allocation decisions.** Prefer $2 of unreportable earnings to $1 of reportable.
7. **Use little debt; structure it long-term and fixed-rate when used.** "We will reject interesting opportunities rather than over-leverage our balance sheet."
8. **No diversification at control prices that destroy shareholder value.** Owners can diversify themselves via direct market purchases.
9. **Test retention by results.** $1 of market value per $1 retained, on a five-year rolling basis. See [dividend-policy](dividend-policy.md).
10. **Issue stock only when receiving as much in business value as given.** All forms — mergers, public offerings, stock-for-debt, options, convertibles. See [stock-as-acquisition-currency](stock-as-acquisition-currency.md).
11. **Do not sell good businesses regardless of price; reluctant to sell sub-par ones if they generate some cash and the people are sound.** Gin-rummy management style is rejected.
12. **Candor in reporting.** Tell the business facts you'd want to know if the positions were reversed. "The CEO who misleads others in public may eventually mislead himself in private."
13. **Reserve on investment activities.** Won't discuss marketable-securities ideas; even denials become tells.

## Why it matters

Three operational consequences distinguish owner-oriented management from the more common reported-numbers-and-management-domain orientation:

- **Communication selects the shareholder base.** Buffett's 1983 "shareholder eugenics" section frames consistent, candid communication as the mechanism by which owner-oriented companies attract long-term owner-partner shareholders rather than short-term traders. The shareholder base, in turn, lets the company act on long-horizon principles without continual pressure to optimize for the next quarter.
...
The 2003 board composition quantified the standard: eleven directors, each (with family) holding over $4M of Berkshire stock, six families with stakes "at least hundreds of millions" held 30+ years — all bought in the open market. See [berkshire-2003-letter](../sources/berkshire-2003-letter.md).
...
When BPL dissolved in 1969, partners received Berkshire shares pro-rata. The 1983 merger of Berkshire and Blue Chip Stamps doubled the shareholder base (1,900 to 2,900) and introduced the partnership principles formally: "Although our form is corporate, our attitude is partnership." "That defined our relationship in 1983; it defines it today." ([berkshire-2020-letter](../sources/berkshire-2020-letter.md))
...
Candor about mistakes implies acting on them. Buffett invokes Munger's term for the failure to do so — **"thumb-sucking"** — and calls delay "the cardinal sin": "Problems … cannot be wished away. They require action, however uncomfortable that may be." The owner-oriented manager not only reports errors honestly but corrects them promptly; an offsetting consolation is that "mistakes fade away; winners can forever blossom" (see [cigar-butts-vs-wonderful-businesses](cigar-butts-vs-wonderful-businesses.md)). The succession passage closes the loop: an owner-oriented culture is durable only if the next CEO shares "the Berkshire creed that a 'report' is what a Berkshire CEO annually owes to owners." See [greg-abel](../people/greg-abel.md). ([berkshire-2024-letter](../sources/berkshire-2024-letter.md))

## How it's discussed in sources

- [berkshire-2024-letter](../sources/berkshire-2024-letter.md) — the "report" vs. mandated-filing distinction ("as we would wish you to use if our positions were reversed"); candor about mistakes as governance ("praise by name, criticize by category"; "mistake/error" used 16 times in 2019–23; the forbidden-word boardroom taboo); Munger's "thumb-sucking" as the cardinal sin of delay; fooling shareholders → fooling yourself; the creed carried forward to Greg Abel
- [berkshire-1983-letter](../sources/berkshire-1983-letter.md) — debut; the 13 principles published as the introduction to the doubled shareholder base after the Blue Chip merger
- [berkshire-1984-letter](../sources/berkshire-1984-letter.md) — repeated emphasis on the owner-as-manager identity ("we receive our rewards as owners, not managers"); the dividend-policy framework operationalizes principle #9; the repurchase doctrine operationalizes principle #10's signaling dimension
- [berkshire-1998-letter](../sources/berkshire-1998-letter.md) — the operating-manager mandate in its canonical three-part form ("own 100% / sole family asset / no sale for a century"); applied to Berkshire's operating CEOs; the GEICO pitch to acquiree CEOs
- [berkshire-1999-letter](../sources/berkshire-1999-letter.md) — the mandate extended as a description of Berkshire's manager culture; Bill Child / R.C. Willey as behavioral exemplar; "We have no contracts at Berkshire"
- [berkshire-2002-letter](../sources/berkshire-2002-letter.md) — the "owner-capitalism" structural argument made against the post-bubble governance scandals; board compensation and D&O design; Buffett's self-admission that "collegiality trumped independence"; directors should act as if there is a single absentee owner
- [berkshire-2003-letter](../sources/berkshire-2003-letter.md) — "owner-capitalism" coined explicitly; the potted-plant test for director judgment; board composition quantified (11 directors, 6 families with hundreds of millions, all open-market purchases, no options/restricted shares); "who ever washes a rental car?"
- [berkshire-2020-letter](../sources/berkshire-2020-letter.md) — five-bucket shareholder taxonomy; Phil Fisher restaurant analogy ("hamburgers and Coke for 56 years"); deepest articulation of the BPL origin story (1956 partnerships → 1962 BPL amalgamation → 1969 dissolution → 1983 Blue Chip merger and first formal partnership principles)

## Related

- [acquisition-criteria](acquisition-criteria.md) — the operating expression of principle #4 (preference for direct + partial business ownership) and #8 (no diversification at control prices)
- [dividend-policy](dividend-policy.md) — principle #9 in detail
- [stock-as-acquisition-currency](stock-as-acquisition-currency.md) — principle #10 in detail
- [share-repurchases](share-repurchases.md) — the signaling dimension of pro-shareholder action
- [institutional-imperative](institutional-imperative.md) — what owner orientation structurally resists
- [incentive-compensation](incentive-compensation.md) — the operating-manager mandate applied to pay design
