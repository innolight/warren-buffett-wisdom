...
Buffett's test for evaluating an investment — applied identically to whole-company acquisitions and to purchases of marketable equity securities. Two versions evolve in parallel through the early letters:

**The four-point principle (1977):** the business must be (1) understandable, (2) with favorable long-term prospects, (3) operated by honest and competent people, (4) available at an attractive price.

**The six-point operational ad (first published 1982):** the published criteria for whole-company acquisitions.

1. Large purchases (≥$5 million of after-tax earnings).
2. Demonstrated consistent earning power (no projections, no turnarounds).
3. Good returns on equity while employing little or no debt.
4. Management in place (Berkshire cannot supply it).
5. Simple businesses (if there's lots of technology, Berkshire won't understand it).
6. An offering price (no preliminary talks without a price).

Plus: no unfriendly transactions; complete confidentiality; "very fast answer — customarily within five minutes."
...
The 1978 letter adds an explicit portfolio-sizing principle: "We try to avoid buying a little of this or that when we are only lukewarm about the business or its price. When we are convinced as to attractiveness, we believe in buying worthwhile amounts." Criterion 4 (attractive price) is not merely a threshold to clear — it is the signal to act with conviction. The 1984 letter restates this as concentration policy: "If you have a harem of forty women, you never get to know any of them very well" (Billy Rose).

## The kissing-toads failure modes (1981)

The 1981 letter sharpens the discipline by inverting it — cataloging the three motivations behind value-destroying acquisitions:

1. **Animal spirits.** Leaders relish increased activity. "At Berkshire, the corporate pulse never beats faster than when an acquisition is in prospect."
2. **Size as the dominant yardstick.** Fortune-500 managers know their sales rank, rarely their profitability rank.
3. **The Pygmalion fantasy.** "Their managerial kiss will turn this toad into a prince." Buffett: "We've observed many kisses but very few miracles."

The two categories of acquisition success (1981) — what *does* work:

- **Category 1: Buying inflation-friendly businesses** — those that can raise prices without losing share AND grow dollar volume without much new capital.
- **Category 2: Managerial superstars** who can recognize the rare prince disguised as a toad. Buffett's named exemplars: Ben Heineman (Northwest Industries), Henry Singleton (Teledyne), Erwin Zaban (National Service Industries), and Tom Murphy (Cap Cities — a "twofer" who operates in both categories).

Buffett's self-assessment in 1981: he does not qualify for Category 2; despite understanding Category 1, Berkshire's record in it has been "sporadic and inadequate" — "we neglected the Noah principle: predicting rain doesn't count, building arks does."

## The 1983 owner's manual codification

The 1983 letter codifies acquisition discipline as principles in the owner's manual:
