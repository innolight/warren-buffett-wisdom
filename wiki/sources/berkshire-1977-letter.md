...
Buffett's first letter under the modern conversational format. Operating earnings of $21.9M ($22.54/share) on a 19% return on beginning equity. Frames the entire investment philosophy that will run through subsequent letters: return on equity (not EPS) as the right yardstick, businesses with tailwinds over those with headwinds, and a four-point test for buying marketable equities the same way one would buy whole businesses.
...
## The Berkshire Fine Spinning digression

A striking aside: Buffett uses Berkshire's own pre-merger history as a cautionary tale. In 1948, Berkshire Fine Spinning + Hathaway Manufacturing earned $18M after tax — more than IBM ($28M), Safeway ($10M), 3M ($13M), or Time ($9M) — and employed 10,000 at a dozen mills. By 1964, after the 1955 merger, aggregate losses of $10M had reduced the operation to two mills and net worth from $53M to $22M. "So much for single year snapshots as adequate portrayals of a business." A candid acknowledgment that the company he runs was, structurally, an early mistake.

## Connections to other sources

First letter in the modern series — no prior wiki source to connect back to. Future letters should reference this one for: the origin of the four-criteria acquisition test, the ROE-as-yardstick framing, the tailwinds/headwinds lesson, and the GEICO and Capital Cities positions in their earliest forms.
