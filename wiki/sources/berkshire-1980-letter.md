...
Operating earnings $41.9M; return on beginning equity (securities at cost) 17.8%, down from 18.6%. Book value per share with insurance equities at market: $400.80, a 16-year compound of 20.5% from $19.46. The conceptual centerpiece is the extensive formalization of **non-controlled ownership earnings** — what later becomes the canonical statement of [look-through-earnings](../concepts/look-through-earnings.md). The GEICO section reframes the company as a franchise temporarily injured, not a turnaround. The insurance section diagnoses the bond-duration trap that will shape industry behavior for years.

## Key themes

- **Look-through earnings, fully articulated.** The "iceberg" framing: only the part of Berkshire's earnings that is paid out as dividends appears above the accounting waterline. With insurance concentration in <20%-owned positions, the part of investee earnings retained for Berkshire's account exceeded total reported Berkshire operating earnings. "If a tree grows in a forest partially owned by us, but we don't record the growth in our financial statements, we still own part of the tree." See [look-through-earnings](../concepts/look-through-earnings.md).
- **Share repurchases as a high-priority use of retained earnings.** First systematic discussion: when a fine business trades at far less than intrinsic value, repurchasing its own shares is among the most certain uses of capital. The competitive nature of acquisitions almost guarantees full price; the auction nature of markets often allows the same earning power at <50% of negotiated cost. See [share-repurchases](../concepts/share-repurchases.md).
...
- [berkshire-hathaway](../entities/berkshire-hathaway.md) — operating earnings $41.9M; 16-year book-value compound 20.5%
- [geico](../entities/geico.md) — 33% equity interest at $47M cost / $105.3M market; framed as franchise, not turnaround
- [national-indemnity](../entities/national-indemnity.md) — Phil Liesche underwriting margins at an all-time high; expected volume decline ahead
- [blue-chip-stamps](../entities/blue-chip-stamps.md) — Berkshire's interest at ~60%
- [wesco-financial](../entities/wesco-financial.md) — Munger and Vincenti credited for Mutual Savings & Loan repositioning
...
- [look-through-earnings](../concepts/look-through-earnings.md) — canonical articulation; the "iceberg" and "tree" formulations
- [share-repurchases](../concepts/share-repurchases.md) — debut as a major capital-allocation theme; the auction-vs-negotiated price gap
- [turnarounds-seldom-turn](../concepts/turnarounds-seldom-turn.md) — extended: GEICO/Amex as the *opposite* of turnarounds; a "Pygmalion" turnaround vs. a localized-cancer franchise rescue
- [investor-misery-index](../concepts/investor-misery-index.md) — restated with the explicit indexing test
- [institutional-imperative](../concepts/institutional-imperative.md) — the bond-duration trap forcing "asset-maintenance underwriting"
- [float](../concepts/float.md) — long bonds at amortized cost as a structural weakness in industry float deployment
...
> GEICO's problems at that time put it in a position analogous to that of American Express in 1964 following the salad oil scandal. Both were one-of-a-kind companies, temporarily reeling from the effects of a fiscal blow that did not destroy their exceptional underlying economics.

> [The second option] might properly be termed "asset maintenance" underwriting — the acceptance of terrible business just to keep the assets you now have.
...
- The look-through framing extends and formalizes the 1977 and 1978 articulations from [berkshire-1977-letter](berkshire-1977-letter.md) and [berkshire-1978-letter](berkshire-1978-letter.md)
- The 1979 insurance forecasts from [berkshire-1979-letter](berkshire-1979-letter.md) proved accurate; combined ratio rose from 100.6 to 103.5
- The GEICO franchise-vs-turnaround reframing inverts the [turnarounds-seldom-turn](../concepts/turnarounds-seldom-turn.md) principle established with Waumbec in [berkshire-1979-letter](berkshire-1979-letter.md)
