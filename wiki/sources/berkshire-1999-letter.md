...
Dated March 1, 2000. Per-share book value up just 0.5% to $37,987 — "the worst absolute performance of my tenure and, compared to the S&P, the worst relative performance as well." The trough year of Berkshire's relative performance during the dot-com mania. Buffett gives himself a "D" in capital allocation. The headline 1999 events: the **acquisition of Jordan's Furniture** and the **MidAmerican Energy deal** (both cash, no Berkshire stock issued); a **$1.4 billion underwriting loss** anchored by a "huge — and, I believe, aberrational — underwriting loss at General Re"; **GEICO's continued surge** (policies-in-force from 2.95M to 4.33M over three years, marketing spend up to $242M); a **canonical share-repurchases essay** restated for an era of "buy high" buybacks; the **circle-of-competence / tech-stocks disclaimer**; and the **acquisition-accounting critique** of pooling and mandatory goodwill amortization. Includes a sober market-outlook reprise of the enclosed *Fortune* article. Lorimer Davidson dies at 97.
...
> Our gain in net worth during 1999 was $358 million, which increased the per-share book value of both our Class A and Class B stock by 0.5%.
...
> To repeat a fact you've heard before, well over 99% of my net worth resides in Berkshire. Neither my wife nor I have ever sold a share of Berkshire and — unless our checks stop clearing — we have no intention of doing so.

> For Berkshire, truly large superiorities over that index are a thing of the past. They existed then because we could buy both businesses and stocks at far more attractive prices than we can now, and also because we then had a much smaller capital base, a situation that allowed us to consider a much wider range of investment opportunities than are available to us today.

> Our optimism about Berkshire's performance is also tempered by the expectation — indeed, in our minds, the virtual certainty — that the S&P will do far less well in the next decade or two than it has done since 1982.

> Businesses such as See's and Buffalo News are now worth fifteen to twenty times the value at which they are carried on our books. Our goal is to continually widen this spread at all subsidiaries.
...
> [On Bill Child and the Boise store:] If a manager has behaved similarly at some other public corporation, I haven't heard about it. You can understand why the opportunity to partner with people like Bill Child causes me to tap dance to work every morning.
...
> But, as I point out in the enclosed article, equity investors currently seem wildly optimistic in their expectations about future returns.
...
## The two-column intrinsic-value table

| Year | Per-Share Investments | Per-Share Pre-tax Operating Earnings (ex-investment income) |
| ---: | ---: | ---: |
| 1969 | $45 | $4.39 |
| 1979 | $577 | $13.07 |
| 1989 | $7,200 | $108.86 |
...
| Decade | Investments | Pre-tax Operating Earnings |
| --- | ---: | ---: |
| 1969-79 | 29.0% | 11.5% |
| 1979-89 | 28.7% | 23.6% |
| 1989-99 | 20.7% | N.A. |
...
The negative 1999 operating-earnings figure is structurally driven by the ~$500M annual goodwill-amortization charge — an accounting fiction Buffett uses the table to expose. The "investment per share" column understates Berkshire's intrinsic value because it excludes the operating businesses, whose intrinsic value Buffett says is multiples of carrying value (See's and Buffalo News "fifteen to twenty times" their book carrying value).
...
| 1967 | — | — | — | $20M | $20M |
| 1977 | — | — | $40M | $131M | $171M |
| 1987 | — | — | $701M | $807M | $1,508M |
| 1997 | $2,917M | — | $4,014M | $455M | $7,386M |
...
| Investee | Berkshire % | Share of Undistributed Earnings |
| --- | ---: | ---: |
| American Express | 11.3% | $228M |
| Coca-Cola | 8.1% | $144M |
| Freddie Mac | 8.6% | $127M |
| Gillette | 9.0% | $53M |
| M&T Bank | 6.5% | $17M |
| Washington Post | 18.3% | $30M |
| Wells Fargo | 3.6% | $108M |
| **Total undistributed** | | **$707M** |
| Hypothetical tax (14%) | | $(99M) |
| Reported operating earnings | | $1,318M |
| **Look-through earnings** | | **$1,926M** |

## Portfolio (yearend 1999)

| Shares | Holding | Cost | Market |
| ---: | --- | ---: | ---: |
| 50,536,900 | American Express | $1,470M | $8,402M |
| 200,000,000 | Coca-Cola | $1,299M | $11,650M |
| 59,559,300 | Freddie Mac | $294M | $2,803M |
| 96,000,000 | Gillette | $600M | $3,954M |
| 1,727,765 | Washington Post | $11M | $960M |
| 59,136,680 | Wells Fargo | $349M | $2,391M |
| | Others | $4,180M | $6,848M |
| | **Total Common Stocks** | **$8,203M** | **$37,008M** |

"We made few portfolio changes in 1999." Several investees had disappointing business results; Berkshire holds because of belief in durable competitive advantages. No tech, by explicit choice. Disney holding (from the 1996 Cap Cities exchange) is in "Others" but no longer disclosed at the level of the top six.

## GEICO scorecard

| Year | New Auto Policies | Total Auto Policies in Force |
| ---: | ---: | ---: |
...
Marketing spend: $33M (1995) → $242M (1999); counselors: 652 → 2,631. Market share in personal auto: 2.7% → 4.1% over three years. Profit-sharing payout: 28.4% of salary ($113.3M total). "We would happily commit $1 billion annually to marketing if we knew we could handle the business smoothly and if we expected the last dollar spent to produce new business at an attractive cost."

The compensation framing: bonus formula uses *only* (1) percentage growth in policyholders and (2) earnings on "seasoned" business (policies in force > 1 year). New-business cost is explicitly excluded — Berkshire "foots the bill" — to avoid penalizing associates for writing initially-unprofitable but long-term-valuable business. The compensation system encodes the long-duration-customer-value thesis.

## Acquisition-accounting essay

Buffett positions himself between FASB and the corporate lobbying against the FASB proposal:

- Pooling is "the fiction" that no purchase occurred. Buffett agrees with FASB that pooling should end.
- Mandatory goodwill amortization is *equally* fiction in the cases that matter: in great businesses, economic goodwill grows, not shrinks. The annual amortization charge "conflicts with reality."
...
The 1970s framework restated:

1. Excess capital beyond near-term business needs (defined as: maintenance capex + value-accretive growth investment).
2. Stock selling below intrinsic value, conservatively calculated.
3. Adequate disclosure so insiders are not buying out uninformed partners.

The 1999 critique: buybacks have become widespread and are too often executed (a) to support the stock price, or (b) to offset option-grant dilution — a "buy high, sell low" pattern that "many unfortunate investors have employed — but never intentionally!" Repurchases at above-intrinsic-value prices transfer value *from* continuing shareholders *to* departing ones.
...
**Jordan's Furniture (Tatelman brothers).** Family business since 1927. Largest furniture retailer in Massachusetts and New Hampshire; highest sales-per-square-foot of any major U.S. furniture operation. "Shoppertainment" model. Cash deal, purchased *assets* (not stock) — enables 15-year goodwill amortization for tax. At closing the Tatelmans paid each employee at least 50¢ per hour worked out of their own pockets — $9M total, not from Berkshire. Fourth furniture acquisition in the NFM-rooted referral chain: Nebraska Furniture Mart (1983) → R.C. Willey (1995) → Star Furniture (1997) → Jordan's (1999). All sourced via prior owners introducing the next.
...
- FlightSafety International (FSI), Executive Jet (EJA/NetJets) — aviation services detail
- Freddie Mac, M&T Bank — investees
- Helzberg's, R.C. Willey, Star Furniture, Dexter Shoe, H.H. Brown, Buffalo News, World Book — operating subs mentioned
...
- Walter Scott — Berkshire director; MidAmerican deal introduction
- David Sokol — MidAmerican CEO
- Al Ueltschi — FlightSafety founder
- Rich Santulli — Executive Jet founder; "invented the fractional-ownership industry in 1986"
- Ron Ferguson — General Re leadership
- Chuck Huggins — See's Candies CEO since 1972
- Louie, Ron, Irv Blumkin — Nebraska Furniture Mart; introduction chain
- Melvyn Wolff, Shirley Toomim — Star Furniture
- Jeff Comment — Helzberg's
- Harold Alfond, Peter Lunder, Frank Rooney, Jim Issler — shoe group
- Rod Eldred, Brad Kinstler, John Kizer, Don Towle, Don Wurster — "other primary" insurance operations
