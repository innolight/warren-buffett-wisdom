...
Dated February 28, 2002. Per-share book value **declined 6.2%** to $37,920 — the first negative year in Berkshire's history under present management; long-term compound 22.6% since 1965. The two defining events of 2001 were **September 11th**, which cost the insurance industry its largest loss ever and Berkshire roughly $2.275B, and the **General Re reckoning** — Buffett's admission that General Re had broken all three of his underwriting rules, that it had under-reserved by approximately $800M in prior years (a "rented suit" buried in earlier numbers), and that he had let Berkshire "operate with a dangerous level of risk" by not converting his recognized fears about uncompensated terrorism exposure into action. Major essays: the **principles of insurance underwriting** (three rules), the **Noah rule** ("predicting rain doesn't count; building arks does"), the canonical **"loss development" critique** of insurance-accounting euphemism, and the **Enron / repricing / option-abuse** opener on corporate-governance rot. Acquisitions: Shaw, Johns Manville, MiTek, XTRA, Larson-Juhl closed; Fruit of the Loom pending. Cost of float: a terrible **12.8%**.
...
- **The cost of float doubles as an industry signal.** With short-term funds yielding under 2% and "fat returns nowhere to be found," every insurance operation save retroactive reinsurance must now produce an underwriting profit to be a good business. The 4%-tolerable-cost era is over.
- **Competitive advantage in jumbo risk.** Berkshire's combination of massive liquid resources, non-insurance earnings, favorable tax position, and "knowledgeable shareholder constituency willing to accept volatility in earnings" lets it write risks beyond any competitor's appetite. The post-9/11 jumbo policies Ajit Jain wrote (South American refinery, airline terrorism, North Sea oil platform, Sears Tower, World Cup, 2002 Winter Olympics) illustrate the franchise.
...
> All of us in the industry made a fundamental underwriting mistake by focusing on experience, rather than exposure, thereby assuming a huge terrorism risk for which we received no premium.

> Bad terminology is the enemy of good thinking.

> The losses didn't "develop" — they were there all along. What developed was management's understanding of the losses (or, in the instances of chicanery, management's willingness to finally fess up).
...
> Insurance accounting is a self-graded exam, in that the insurer gives some figures to its auditing firm and generally doesn't get an argument.
...
> In recent years, Lou's performance has been far better than mine. [On Lou Simpson at GEICO.]

> Tony is an owner's dream. [On Tony Nicely at GEICO.]

## The three principles of insurance underwriting (verbatim)
...
Cost of float in 2001: **12.8%** — worst year since 1984; the 2000 cost had been 6%. GEICO produced a $221M underwriting profit (negative cost) on $4.25B of float; reinsurance underwriting losses were $1.416B pre-tax.

## The General Re reckoning

Three concurrent failures, each individually addressable, jointly compounding:

- **Under-reserving.** $800M of prior-year loss costs belatedly recognized in 2001. Under-reserving caused under-pricing (because true costs weren't known), which in turn caused excessive incentive comp and premature tax payments.
- **Market-share over profit.** "Overly-competitive in going after, and retaining, business." Hard-driving professionals who measure themselves against competitors equate winning with volume, not underwriting profit.
- **Exposure blind spot.** Terrorism risk was assumed for free; experience-based pricing missed it.

Joe Brandon (CEO from September 2001) and Tad Montross (president) tasked with restoring discipline. Buffett's framing: General Re, when independent, "often shone," and with Berkshire's added balance sheet should be a major asset — once the discipline is back.

## Sources of reported earnings

Pre-tax 2001 (selected, $ millions):

| Segment | 2000 | 2001 |
| --- | ---: | ---: |
| Underwriting – Reinsurance | (211) ¹ | (4,318) |
| Underwriting – GEICO | (224) | 221 |
| Underwriting – Other Primary | 25 | 30 |
| Net Investment Income | 2,773 | 2,824 |
| Building Products | 34 | 461 |
| Finance & Financial Products | 530 | 519 |
| Flight Services | 213 | 186 |
| MidAmerican Energy (76%) | 197 | 600 |
| Retail Operations | 175 | 175 |
| Scott Fetzer (ex-finance) | 122 | 129 |
| Shaw Industries (from Jan 8, 2001) | — | 292 |
| Other Businesses | 221 | 179 |
| Purchase-Accounting Adjustments | (881) | (726) |
| **Operating Earnings** | 1,699 | 488 |
| Capital Gains | 3,955 | 1,320 |
| **Total Earnings** | 5,654 | 1,808 |

¹ The 2000 reinsurance underwriting comparable as restated in the 2001 table.

The Shaw and Johns Manville closures (announced in 2000) flowed through and gave Buffett a $659M pre-tax block of new operating earnings to point at amidst the insurance disaster.

## Portfolio (yearend 2001)

| Shares | Holding | Cost | Market |
| ---: | --- | ---: | ---: |
| 151,610,700 | American Express | $1,470M | $5,410M |
| 200,000,000 | Coca-Cola | $1,299M | $9,430M |
| 96,000,000 | Gillette | $600M | $3,206M |
| 15,999,200 | H&R Block | $255M | $715M |
| 24,000,000 | Moody's | $499M | $957M |
| 1,727,765 | Washington Post | $11M | $916M |
| 53,265,080 | Wells Fargo | $306M | $2,315M |
| | Others | $4,103M | $5,726M |
| | **Total Common Stocks** | **$8,543M** | **$28,675M** |

"We made few changes in our portfolio during 2001. As a group, our larger holdings have performed poorly in the last few years … But we do not believe Berkshire's equity holdings as a group are undervalued."

## Junk bonds and distressed debt

Active in 2001 in a way Berkshire had not been since the 1989 WPPSS / 1980s zero-coupon era. Never bought a newly-issued junk bond. Three prior canonical distressed names cited: Chrysler Financial, Texaco, RJR Nabisco — "all of which returned to grace." 2001 distressed positions: Fruit of the Loom's public and bank debt at ~50% of face (became route into whole-company acquisition); FINOVA at ~67% of face (became Berkadia).
...
- XTRA — acquired post-9/11; trailer leasing; Lew Rubin
- Larson-Juhl — picture frames; closed shortly after letter date
- Fruit of the Loom — bankruptcy bid pending; John Holland required as condition; Buffett's 1955 P&R/Union Underwear loop
- Benjamin Moore — first full year (from Dec 2000 close)
...
- FleetBoston (formerly First National Bank of Boston) — 1969 Illinois National financing relationship redux
- Acme Boot — H.H. Brown bolt-on; second-purchase-of-P&R loop
- Tiger Fund (Julian Robertson) — XTRA seller
- Planned Parenthood / Metro Right to Life — shareholder-designated contributions defense
- Enron — opening symbol of "shareholder abuse"
...
- Gene Toombs — MiTek CEO
- Lew Rubin — XTRA CEO
- Craig Ponzio — Larson-Juhl owner
- Steve McKenzie — Larson-Juhl CEO
- John Holland — Fruit of the Loom; required-as-CEO condition
- Jack Goldfarb — sold Union Underwear to P&R in 1955
- Bill Child — R.C. Willey; Boise/Las Vegas Sunday-closed expansion
- Frank Rooney, Jim Issler — H.H. Brown; absorbed Dexter
- Bob Shaw — Shaw Industries
- Jerry Henry — Johns Manville
- Yvan Dupuy — Benjamin Moore
- Al Ueltschi — FlightSafety; 84; $10,000 1951 start
- Rich Santulli — NetJets; inventor of fractional ownership
- Ron Peltier — HomeServices
- Julian Robertson — Tiger Fund; XTRA seller
- Chad Gifford — FleetBoston president
- Bill Brown, Ira Stepanian — 1969 First National Bank of Boston counterparts
- Jack Welch — *Jack, Straight from the Gut* recommended; Brandon comparison
- Robert P. Miles — author of *The Warren Buffett CEO*
- Horace — frontispiece-of-Security-Analysis quote
