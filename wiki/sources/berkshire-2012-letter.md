...
Berkshire achieved a total gain for shareholders of $24.1 billion in 2012, with per-share book value rising 14.4% — the 9th time in 48 years Berkshire underperformed the S&P (which gained more in strong markets, per Buffett's own expectation). The letter is most notable for its detailed mathematical treatment of dividend policy vs. the "sell-off" alternative, and marks Berkshire's 10th consecutive underwriting profit with float reaching $73.1 billion.
...
- **Newspapers** — 28 daily papers acquired over 15 months for $344M. Rationale: local news monopoly still viable; pay model is the right digital strategy. Buffett explicitly acknowledges declining economics and does not expect success from content cuts or lower publication frequency. Stan Lipsey retires from The Buffalo News.
- **Non-real amortization** — detailed accounting lecture on GAAP vs. economic amortization. Software amortization is real; amortization of customer relationships is not. Wells Fargo's "amortization of core deposits" ($1.5B/year) is the most striking example of an accounting charge that bears no relationship to economic reality.
- **Investment-manager succession** — Cultural and intellectual fit as primary selection criteria, not pedigree or prior track record length. Combs and Weschler's double-digit S&P outperformance in their first full years together, and promotion to managing ~$5B each (including subsidiary pension funds), validates the model: identify successors years before they're needed, grant growing autonomy, and let genuine records form under real conditions rather than auditions.
- **Capital expenditure record** — $9.8B spent on plant and equipment in 2012 (88% in U.S.), 19% above 2011, itself a prior record. Buffett's counter to CEO "uncertainty" rhetoric: "If you are a CEO who has some large, profitable project you are shelving because of short-term worries, call Berkshire. Let us unburden you."
...
> You can successfully run a restaurant that serves hamburgers or, alternatively, one that features Chinese food. But you can't switch capriciously between the two and retain the fans of either. — citing Phil Fisher's *Common Stocks and Uncommon Profits*
