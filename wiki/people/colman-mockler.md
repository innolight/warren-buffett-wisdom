...
Drawing on the 1990 letter (which references a contemporaneous *Forbes* cover story on Gillette):

- **Quality as the recurring strategic pivot.** *Forbes*'s framing, endorsed by Buffett: Gillette's success came "not from marketing savvy (though it exhibits that talent repeatedly) but has instead resulted from its devotion to quality. This mind-set has caused it to consistently focus its energies on coming up with something better, even though its existing products already ranked as the class of the field."
- **The Sensor razor (1989-90).** Premium-priced product launched into Gillette's existing customer base — and accepted at the premium, validating the franchise. Buffett's 1989 endorsement: "If you haven't tried Gillette's new Sensor razor, go right out and get one." The empirical signature: customers who already had the leading product willingly paid more for a better one.
- **Defense against takeover.** Mockler successfully defended Gillette against several takeover attempts in the mid-1980s. The Berkshire preferred investment in 1989 came partly in the context of completing Gillette's transition to a stable independent capital structure.
