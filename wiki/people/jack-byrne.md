...
### 2. Succession as an extension of stewardship

By the time Byrne leaves GEICO in mid-1985, he has identified, developed, and entrenched two successors — **Bill Snyder** as chairman and **Lou Simpson** as vice chairman. The 1985 letter highlights this as the second contribution, distinct from the rescue itself:
...
This is a Buffett-favored signature of a great operator: that the institutional capacity outlasts the individual.
...
- **The underwriting-discipline-first school.** Byrne's GEICO operating philosophy elevates the loss-reserve and underwriting cycle above headline growth — a stance Buffett endorses across the 1980s letters and applies to his own insurance subsidiaries (with mixed personal results, by his own admission).
- **Distribution structure as the durable advantage.** Byrne's GEICO inherits the direct-to-consumer model as a structural feature; his contribution is recognizing that the franchise resides *there*, not in any of the surface-level operating choices that needed fixing.
