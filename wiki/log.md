...
## [2026-08-23] query | what Buffett & Munger look for when reading an earnings call

- Question asked: what does Buffett look for in an earnings call, what questions would he seek answers to, and what are the Buffett/Munger mental models for reading one.
- Created `synthesis/earnings-call-mental-models.md` (draft). Filed because the answer is genuinely non-obvious: the honest finding is that Buffett **does not attend or value earnings calls at all** (PetroChina bought on the annual report alone, [berkshire-2008-meeting](sources/berkshire-2008-meeting.md); Berkshire itself gives no guidance and holds no investor calls, [berkshire-2018-meeting](sources/berkshire-2018-meeting.md)). The page is built on the inversion that follows — a call is worthless as a source of facts and useful only as a controlled experiment on management's character.
- Structure: eight mental models (document-first; candor as leading indicator; vocabulary as tell; smoothness as red flag; follow the incentive; the call as the transmission channel of the institutional imperative; needing the call means you're outside your circle; test capital-allocation claims against actions), a twelve-question list grouped by economics / capital allocation / accounting / character, a "what they'd ignore" list, and a limits section.
- Grounded in raw transcripts read directly, not just wiki pages: 1996, 1999, 2004, 2005, 2008, 2013, 2016, 2018 meetings + 1983, 2000, 2001, 2015, 2016, 2018 letters.
- **Deliberately included the pushback rather than smoothing it**: three stated limits (permanent-capital dependency; selection effect — he only buys businesses where filings suffice; and Buffett/Munger's own 2013 admission that financial statements are *less* useful than 40 years ago, which cuts against the anti-call stance). Also recorded Buffett's refusal to give a manipulation checklist.
- No concept pages created — the accounting substance already lives in [earnings-quality](concepts/earnings-quality.md) and [gaap-distortion](concepts/gaap-distortion.md), and the management substance in [buffett-management-criteria](synthesis/buffett-management-criteria.md); the new page cross-links rather than duplicates.
- Updated `index.md` (Synthesis section).
- **Same-day revision to model 3** on user feedback: "real cost" was used as an undefined term doing all the argumentative work. Added an explicit test — a charge is real if it reduces what the owner can take out, either by consuming cash or by transferring away the owner's claim — and separated two things management conflates: "non-recurring" (a frequency claim) and "non-cash" (a timing/form claim), neither of which answers whether the owner bore the cost. Table column reworded to answer that question directly.
- ⚠️ **Open inconsistency to resolve**: [earnings-quality](concepts/earnings-quality.md) states the test as recurrence ("if it recurs year after year... it is a real cost"). The new framing argues recurrence is evidence that an exclusion is *dishonest*, not the criterion for whether a cost is *real* — a once-off charge paid out of owners' money is still real. The concept page should be sharpened to match, pending user review.
