...
Borsheim's is the second clean illustration of what becomes a Berkshire archetype during this decade: a **single-location, low-cost, broad-selection, family-run retailer that dramatically out-sells geographically-distant competitors**. The Blumkin/Friedman/Heldman pattern — owner-managers who want financial diversification but want to keep running their businesses — becomes Berkshire's "favorite form of purchase" articulated in the acquisition criteria from 1988 onward.

The 1989 letter spells out the five-factor formula explicitly, treating Borsheim's and NFM as embodying the same model:
...
3. Rapid turnover.
4. Shrewd buying, made possible in part by the huge volumes purchased.
5. Incredibly low expenses.

The combination of the last three lets both stores offer everyday prices no one in the country comes close to matching. The 1990 letter quantifies: operating costs of about 18% of sales vs. ~40% at the typical fine-jewelry competitor. "What works with diapers works with diamonds."
...
## National reach from a single store

The most surprising operational feature: Borsheim's serves customers nationwide from one Omaha location. Mechanism: by mail. The 1990 letter describes the protocol:
...
>
> ... Misanthropes will be crushed to learn how well our "honor-system" works: We have yet to experience a loss from customer dishonesty.
...
A line attributed to Buffett in the 1988 letter:
...
The principle: in a market where the customer cannot reliably evaluate the product, the reputation of the merchant becomes the moat. Ike Friedman's integrity (and the entire Friedman family's by extension) is the structural feature on which the business depends. The 1989 letter's illustrative story — Ike at a small business gathering, security guards stationed outside the safe, leaning over to whisper "and besides, Warren, the jewels aren't in the safe" — is in the wiki record as canonical Buffett-on-Ike.
