...
1. **The Buffett-Amex history is the original "great franchise with localized fixable problem" template.** Buffett Partnership Ltd. invested ~40% of its capital in American Express in the mid-1960s following the salad-oil scandal — at a price of ~$13M for over 5% of the company. The 1980 letter ([berkshire-1980-letter](../sources/berkshire-1980-letter.md), discussed in [geico](geico.md)) explicitly invokes the parallel: "GEICO's problems at that time put it in a position analogous to that of American Express in 1964 following the salad oil scandal. Both were one-of-a-kind companies, temporarily reeling from the effects of a fiscal blow that did not destroy their exceptional underlying economics." Amex 1964 is the original "franchise, not turnaround" case; GEICO 1976 is the second.

2. **The card franchise itself is a Buffett-style moat.** Brand-driven preference, two-sided network economics (merchants accept because cardholders use; cardholders use because merchants accept), and structurally high return on capital because the float and credit relationships throw off cash without large physical asset requirements.

## The PERC (1991)

The 1991 letter describes the structure carefully because it is not a normal preferred:

- $300M cost.
- Fixed 8.85% dividend.
- Mandatory conversion three years after issuance.
- Conversion ratio set so the maximum value of common received at conversion is $414M (a ceiling on upside).
- No floor — Berkshire takes downside common-stock risk.
- A one-year extension is available if Amex stock is below $24.50 on the third anniversary.

The hybrid is mostly common-stock economics with a yield kicker rather than the other way around. The 1995 letter treats the PERC separately from the four convertible preferreds (Salomon, Gillette, USAir, Champion) for exactly this reason: PERCs are "a modified form of common stock whose fixed-income characteristics contributed only a minor portion of its initial value."

## Position evolution

| Year | Form | Shares | Cost | Market |
| --- | --- | ---: | ---: | ---: |
| 1991 | PERC | — | $300.0M | $263.3M |
| 1992 | PERC | — | $300.0M | $309.0M |
...
## The 1994 addition rationale

The 1994 letter explains why Berkshire enlarged Amex into a top-tier position. Two threads:

- **Familiarity over decades.** "My American Express history includes a couple of episodes: In the mid-1960's, just after the stock was battered by the company's infamous salad-oil scandal, we put about 40% of Buffett Partnership Ltd.'s capital into the stock — the largest investment the partnership had ever made. … (Amex earned $12.5 million in 1964 and $1.4 billion in 1994.)"
- **IDS history.** "My history with Amex's IDS unit, which today contributes about a third of the earnings of the company, goes back even further. I first purchased stock in IDS in 1953 when it was growing rapidly and selling at a price-earnings ratio of only 3."
...
- [berkshire-1991-letter](../sources/berkshire-1991-letter.md) — PERC purchased; structure described; first appearance in fixed-income table
- [berkshire-1992-letter](../sources/berkshire-1992-letter.md) — PERC carried at $300M cost, $309M market
- [berkshire-1993-letter](../sources/berkshire-1993-letter.md) — first appearance as common; 2.4% ownership; $16M look-through
- [berkshire-1994-letter](../sources/berkshire-1994-letter.md) — major addition to 27.8M shares; the partnership-era retrospective; "from $12.5 million to $1.4 billion"
- [berkshire-1995-letter](../sources/berkshire-1995-letter.md) — addition to 49.5M shares (just under 10%); included in the top portfolio holdings
- [berkshire-1997-letter](../sources/berkshire-1997-letter.md) — 49.5M shares; $4,414M market; 10.7% look-through contributing $161M undistributed; Prouts Neck origin story retold; Harvey Golub praised as CEO
- [berkshire-1998-letter](../sources/berkshire-1998-letter.md) — slight addition to 50.5M shares; cost $1,470M; $5,180M market; last position change per 2003 letter
- [berkshire-1999-letter](../sources/berkshire-1999-letter.md) — "badly lagged the market in 1999"; held for competitive-advantage conviction; look-through 11.3%, $228M undistributed
- [berkshire-2000-letter](../sources/berkshire-2000-letter.md) — 3-for-1 stock split to 151.6M shares; $8,329M market; look-through 11.4%, $265M; major positions "essentially unchanged"
- [berkshire-2001-letter](../sources/berkshire-2001-letter.md) — held through 9/11 downturn; $5,410M market
- [berkshire-2002-letter](../sources/berkshire-2002-letter.md) — "earnings up, valuations down"; $5,359M market
- [berkshire-2003-letter](../sources/berkshire-2003-letter.md) — "last position change in 1998"; $7,312M market; 11.8% ownership; position fully priced but business quality intact

- [berkshire-2022-letter](../sources/berkshire-2022-letter.md) — the 28-year compounding arc quantified: $1.3B cost → $22B market value; $41M dividends → $302M annually; paired with Coke as the definitive "Secret Sauce" illustration; "all we were required to do was cash the quarterly dividend checks"

## Related

- [geico](geico.md) — the 1980 framing of "franchise with localized fixable problem" is built on the Amex 1964 precedent
- [franchise-vs-business](../concepts/franchise-vs-business.md) — the card network is a textbook two-sided franchise
- [warren-buffett](../people/warren-buffett.md) — Buffett Partnership's 1964 commitment is part of his canonical investing biography
- [concentration-vs-diversification](../concepts/concentration-vs-diversification.md) — adding into a known-well franchise at scale exemplifies the discipline
